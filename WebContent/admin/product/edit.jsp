...
<body style="background:url(${pageContext.request.contextPath}/admin/images/bg-admin.jpg) repeat;">
	...
	<div class="width-900 margin-auto-w padding-top-40">
		<div class="height-40 line-height-40 color-white text-center font-bold font-16">商品编辑</div>

		<form id="productForm" action="${pageContext.request.contextPath}/adminproduct_update.action" method="post" enctype="multipart/form-data">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab" class="margin-top-10">
				<tr class="border-bottom-solid">
				  	...
				  	<td align="center" valign="middle" class="borderright bordebottom" style="width:35%">
				  		<input id="pname" type="text" name="pname" value="<s:property value="model.pname"/>" placeholder="请输入商品名称" class="width-220 height-30 line-height-30 padding-left-10 border-solid border-radius-3 color-boldgray font-yahei">
				  	</td>
				...
				<tr class="border-bottom-solid">
				  	...
				  	<td align="center" valign="middle" class="borderright bordebottom" style="width:35%">
				  		<input id="market_price" type="text" name="market_price" value="<s:property value="model.market_price"/>" placeholder="请输入市场价格" class="width-220 height-30 line-height-30 padding-left-10 border-solid border-radius-3 color-boldgray font-yahei">
				  	</td>
				  	<td align="center" valign="middle" class="borderright bordebottom font-boldgray font-16 font-bold" style="width:15%">商城价格：</td>
				  	<td align="center" valign="middle" class="borderright bordebottom" style="width:35%">
				  		<input id="shop_price" type="text" name="shop_price" value="<s:property value="model.shop_price"/>" placeholder="请输入商城价格" class="width-220 height-30 line-height-30 padding-left-10 border-solid border-radius-3 color-boldgray font-yahei">
				  	</td>
				</tr>
				<tr class="border-bottom-solid">
				  	...
				  	<td align="center" valign="middle" class="borderright" style="width:35%">
				  		<span class="vertical-middle"><input type="radio" name="is_hot" value="1" class="vertical-middle" style="margin:0 5px;" <s:if test="model.is_hot == 1">checked</s:if>>是</span>
				  		<span class="margin-left-10 vertical-middle"><input type="radio" name="is_hot" value="0" class="vertical-middle" style="margin:0 5px;" <s:if test="model.is_hot == 0">checked</s:if>>否</span>
				  	</td>
			  		<td align="center" valign="middle" class="borderright font-boldgray font-16 font-bold" style="width:15%">商品图片：</td>
				  	<td align="center" valign="middle" class="borderright" style="width:35%">
				  		<img src="${pageContext.request.contextPath}/<s:property value="model.image"/>" width="30" height="30"/>
				...
				<tr class="border-bottom-solid">
				  	...
				  	<td align="center" valign="middle" class="borderright" colspan="3">
				  		<div class="padding-10">
				  			<textarea id="pdesc" name="pdesc" class="line-height-30 padding-left-10 padding-top-10 padding-bottom-10 border-solid border-radius-3 color-boldgray font-yahei" placeholder="请输入商品描述" style="width:90%; height:70px;"><s:property value="model.pdesc"/></textarea>
				  		</div>
				  	</td>
				</tr>
